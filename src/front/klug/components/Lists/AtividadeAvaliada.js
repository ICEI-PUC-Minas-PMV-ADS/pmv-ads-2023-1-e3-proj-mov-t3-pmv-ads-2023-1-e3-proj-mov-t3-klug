  ...
  return (
    <div style={styles.container}>
      <div style={styles.containerInfo}>
        ...
        <Text style={{fontSize: 16, margin: 2, color: '#13315C'}}>Avaliada em {props.DataPublicação}</Text>
      </div>
      <div style={styles.containerNota}>
        <Text style={{fontSize: 15, margin: 3, color: '#13315C'}}>Nota: {props.NotaAluno} / {props.Total}</Text>
      </div>
    </div>
  );
}